    ...
    public partial class CFXR_Effect : MonoBehaviour {
        ...
        private void Update() {
            ...
            if (clearBehavior != ClearBehavior.None) {
                ...
                // Check isAlive every N frame, with an offset so that all active effects aren't
                // checked at once
...
#if UNITY_EDITOR
        // Editor preview Detect when the Particle System is previewing and trigger this animation too
        ...
        private void onEditorUpdate() {
            ...
            // Need to track unwrapped time when playing back from Editor because the
            // parentParticle.time will be reset at each loop
